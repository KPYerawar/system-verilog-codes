...
class my_agent22 extends uvm_agent ;
  ...
  virtual function void build_phase(uvm_phase phase);
    super.build_phase(phase);
    d1 = my_driver22::type_id::create("d1",this);
    m1 = my_monitor22::type_id::create("m1",this);
  endfunction  
endclass
  
class my_env22 extends uvm_env ;
  `uvm_component_utils(my_env22)
   my_agent22 a1;
   
  function new(string name  = "my_env22", uvm_component parent = null);
    super.new(name,parent);
  endfunction 
  ...
  virtual function void build_phase(uvm_phase phase);
    ...
    `uvm_info ("HELLO FROM ENV"," ",UVM_LOW);
    a1 = my_agent22::type_id::create("a1",this);
  endfunction 
endclass 

class my_test22 extends uvm_test ;
  `uvm_component_utils(my_test22)
      my_env22 e1 ;
  ...
  virtual function void build_phase(uvm_phase phase);
    ...
    `uvm_info ("HELLO FROM test"," ",UVM_LOW);
    e1 = my_env22::type_id::create("e1",this);
  endfunction 
endclass 

  
module UVM_CODE23_TEST_ENV ;
  bit clk ;
  always #1 clk = ~clk ;
  my_if22 inf(clk);
  initial begin 
